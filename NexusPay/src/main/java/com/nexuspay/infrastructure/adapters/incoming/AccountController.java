...
public class AccountController {
    ...
    @PostMapping
    public ResponseEntity<Account> createAccount(@Valid @RequestBody AccountRequest request) { // <--- Agregado @Valid
    ...
    public ResponseEntity<Void> deposit(@PathVariable UUID id, @RequestParam BigDecimal amount) {
        // Nota: @Valid no se usa directamente en @RequestParam sencillos,
        // la lógica de negocio del Service seguirá protegiendo este campo.
